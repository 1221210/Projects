//Mergesort.java
//This part of the program sorts an array with merge sort

public class MergeSortTest 
{
	// calls recursive split method to begin merge sorting
	public static int counterCombined;
	public static int counterFinal;
	public static void mergeSort(int[]data)
	{
		sortArray(data, 0, data.length - 1); //sorts the entire array
	} // end method sort
	...
	private static void sortArray (int[] data, int low, int high)
	{
		...
		sortArray(data, low, middle1); // first half of the array
		sortArray(data, middle2, high); // second half of the array
		...
		int middle2, int right)
	{
		...
		int combinedIndex = left; // index into temp working array
		int[] combined = new int[data.length]; // working array
		 counterFinal = counterCombined;
		counterCombined = 0;
		...
		while (leftIndex <= middle1 && rightIndex <= right)
		{
			...
			else combined[combinedIndex++] = data[rightIndex++];
		}
	...
	private static String subarrayString(int[] data, int low, int high)
	{
		...
		counterCombined = counterCombined + counterFinal;
