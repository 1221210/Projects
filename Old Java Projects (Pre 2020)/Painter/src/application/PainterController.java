...
public class PainterController 
{
    ...
    @FXML private RadioButton orangeRadioButton; // orange radio button
    ...
    {
    	// setting colors for each radio button / pensize for each
...
/*
 * 
 *  scarletRadioButton.setUserData(Color.decode("#FF2400")); // scarlet radio button
        customGreenRadioButton.setUserData(Color.decode("#00FF24")); // hex #00FF24 green
        orangeRadioButton.setUserData(Color.ORANGE);
        guppieGreenRadioButton.setUserData(Color.decode("#00FFA4")); // guppie green  #00FFA4
        smallRadioButton.setUserData(PenSize.SMALL);
        mediumRadioButton.setUserData(PenSize.MEDIUM);
        largeRadioButton.setUserData(PenSize.LARGE);
        XSRadioButton.setUserData(PenSize.XS); // extra small button
