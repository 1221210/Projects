package smallgroupch5controlstructurescourtwarming;
...
public class SmallGroupCh5ControlStructuresCourtwarming {
...
// print statements displaying if canidate is running for king or queen, their name , their information, and their total votes
...
for (int i = 0; i<8; i++) // for loop for kings vote win calc
{
 ...
 leastVotesIndex = 9;
for (int i = 0; i<8; i++) // for loop for queen vote win calc
{
