...
void getInfo(string & name, int& nbrMonths, int& nbrTraining, int& age)
{
	...
	case 3:
	{
		if (userInput == 4)
		{
			cout << "You have selected both. " << endl; //states service
			cout << "Please enter how many sessions of personal training and  standard membership you want. Sessions are 25$ each and Membership is ";
			cout<<	"$20 monthly. " << endl;
			cin >> nbrTraining;
			if (age >= 55)
			{
				cout << "Since you are a senior citizen we are applying a 30% discount to your total." << endl;
...
case 4:
	{
		if (userInput != 2 && userInput != 1 && userInput != 3) // if answer is not what is requested it results in an error
		{
